...
public:
    double findMedianSortedArrays(vector<int>& nums1, vector<int>& nums2) {
        ...
        while (l <= r) {
            int m = l + (r-l)/2; //for smaller (index of the right most value of the left partition on this array)
            int m2 = (half - (m+1))-1; //for bigger (index of the right most value of the left partition on this array)
